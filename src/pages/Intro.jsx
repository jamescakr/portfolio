  ...
  return (
    <Layout paddingTop="pt-50">
      <motion.div variants={containerVariant} initial="hidden" animate="show">
        ...
        >
          <div>
            With a strong foundation in web development and hands-on experience
            across <span className="text-[#64FFDA]">HTML, CSS, JavaScript,</span> and{" "}
            <span className="text-[#64FFDA]">NodeJS,</span> I am expanding my
